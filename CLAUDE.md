...
- Plan 3 decomposed into A/B/C/D (see M0 remaining work). HDR-012 recorded (deliberation is a separate front-end layer, coupled only via the plan/goal artifact). Sub-plan A spec written + approved ([docs/specs/2026-06-16-sb-worker-loop-design.md](docs/specs/2026-06-16-sb-worker-loop-design.md)); B/C/D being specced ahead as runway before implementation. Next: writing-plans → subagent-driven execution of A.
