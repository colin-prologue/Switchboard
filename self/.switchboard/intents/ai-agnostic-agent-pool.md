...
- **Last verified source base:** accepted Stage 7 contract commit `a0b125a`.
  The Slice 1 implementation branch passes `UV_CACHE_DIR=/private/tmp/switchboard-uv-cache
