...
- **Copied at commit:** `<fill in the SHA you copied>`
- **Copied on:** 2026-06-29
- **License:** check Symphony's `LICENSE` at the copied commit and retain the
  required attribution here. (Symphony was published as an open spec; comply with
  whatever license it ships under.)
